...
def ligand_query(string, question, progress_callback=None):
    ...
    final_rels = unique_ligand_target_disease_paths_rels_list + unique_ligand_target_target_paths_rels_list

    return final_formatted_list, final_nodes_list, final_rels
...
def disease_query(string, question, progress_callback=None):
    ...
    final_rels = unique_disease_target_ppi_paths_rels_list + unique_disease_target_target_paths_rels_list
...
def target_query(string, question, progress_callback=None):
    ...
    final_rels = unique_target_disease_target_paths_rels_list
